...
export const createExpenseValidator = z
    .object({
        ...
        refundable_amount: z.number().nonnegative().optional(),
        is_planned: z.boolean().optional().default(false),
        payment_deadline: z.string().date().optional(),
        notes: z.string().optional(),
    })
    .refine((d) => d.category_id || d.category_name, { message: 'Either category_id or category_name is required' });
